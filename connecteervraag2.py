...
def vrgbutton():
    ...
    vraagzin1 = select_database("vraag", "questions", 2)
...
def klbutton():
    ...
    for i in antwoord1.curselection():
        ...
        my_conn.execute(("SELECT juist_ant FROM answer WHERE question_id = 2 AND answertext = %s"),(an1,))
...
my_conn.execute(("SELECT answertext FROM answer WHERE question_id = 2"))
